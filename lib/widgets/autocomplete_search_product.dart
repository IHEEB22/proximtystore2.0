...
class AutocompleteSearchProduct extends StatefulWidget {
  ...
  @override
  State<AutocompleteSearchProduct> createState() =>
      _AutocompleteSearchProductState();
}
...
// :
                      ...
                      return Consumer<BusinessProvider>(
                        builder: (context, value, child) => Container(
                          ...
                          child: TypeAheadFormField<Product>(
                            ...
                            // change it dynamicly
                            hideSuggestionsOnKeyboardHide: context
                                .watch<BusinessProvider>()
                                .hideSuggestionList,
                            suggestionsBoxDecoration: SuggestionsBoxDecoration(
                              color: AppColors.invisibleColor,
                              constraints: BoxConstraints(
                                  maxHeight: 0.548.sh, minHeight: 0.548.sh),
                              offsetX: 1.02,
                              elevation: 0,
                            ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Padding(
                                          padding:
                                              EdgeInsets.only(left: 0.0321.sw),
                                          child: Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            mainAxisAlignment:
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIconConstraints: BoxConstraints(
                                    maxHeight: 0.028.sh, maxWidth: 0.1.sw),
                                prefixIcon: Image(
                                    height: 0.12.sh,
                                    width: 0.2.sw,
                                    image: AssetImage(
          ...
          } else if (snapshot.hasError) print(snapshot.hasError);
          return SizedBox();
        });
  }
}
