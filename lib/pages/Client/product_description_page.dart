      ...
      body: SafeArea(
        child: Stack(
          children: [
            Scaffold(
              body: FutureBuilder(
                  future: FireStoreServices().getStoreDetails(
                      context.read<ClientProvider>().productSelected!.storeId),
                  builder:
                      ...
                      return SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsets.symmetric(horizontal: 0.0453.sw),
                              child: Column(
                                children: [
                                  Text(
                                      context
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            snapshot.data!.storeStatus ?? false
                                                ? 'open'.tr()
                                                : 'close'.tr(),
                                            style: Theme.of(context)
                                                .textTheme
                            ...
                            Padding(
                              padding:
                                  EdgeInsets.symmetric(horizontal: 0.0426.sw),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
